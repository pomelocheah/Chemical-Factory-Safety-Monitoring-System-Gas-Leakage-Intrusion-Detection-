...
// ========== WiFi ==========
const char* ssid = "sechin1206";
const char* password = "0105414590abc";
...
void callback(char* topic, byte* payload, unsigned int length)
{
    ...
    if (msg == "1")
    {
        Serial.println("YOLO: Person Detected");
        yoloPerson = true;
    }
    else if (msg == "0")
    {
        Serial.println("YOLO: No Person");
        yoloPerson = false;
    }
    }
}
...
void loop() {
  ...
  display.print("Yolo:"); display.print(yoloPerson);
